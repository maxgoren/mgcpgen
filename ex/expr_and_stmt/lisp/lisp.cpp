...
ParseTable lispGrammar() {
    Grammar G;
    G.terminals = {"TK_LPAREN", "TK_RPAREN", "TK_ID", "TK_NUM", "TK_PLUS", "TK_MINUS", "TK_SUB", "TK_PRINT", "$$", EPS };
    G.nonterminals = {"sexpr", "atom", "list"};
    ...
    G.productions["atom"] = ProductionSet({Production(3, "atom", SymbolString({"TK_ID"})),
                                            ...
                                            Production(5, "atom", SymbolString({"TK_MUL"})),
                                            Production(6, "atom", SymbolString({"TK_PLUS"})),
                                            Production(7, "atom", SymbolString({"TK_MINUS"}))});
