...
enum EXPR_TYPE {
    BIN_EXPR, UNARY_EXPR, ID_EXPR, NUM_EXPR, STRING_EXPR, FUNC_EXPR, LIST_EXPR, SUBSCRIPT_EXPR, LAMBDA_EXPR
};

enum STMT_TYPE {  
    IF_STMT, WHILE_STMT, PRINT_STMT, DEF_STMT, EXPR_STMT, BLOCK_STMT, LET_STMT, RETURN_STMT
};
